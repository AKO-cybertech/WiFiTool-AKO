...
def slow_banner():
    ...
    typewrite(f"{BR}{O}             WiFi Multi-Tool  v3.3  —  By AKO{RS}", delay=0.025)
...
{BR}{R}  ╚███╔███╔╝██║██║     ██║    ██║ ╚═╝ ██║╚██████╔╝███████╗██║   ██║{RS}
{BR}{O}   ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝    ╚═╝     ╚═╝ ╚═════╝ ╚══════╝╚═╝   ╚═╝{RS}
{D}               WiFi Multi-Tool  v3.3  —  By AKO{RS}
"""

MENU = f"""
{sep()}
{BR}{W}  MENU PRINCIPAL  {D}· v3.3 · By AKO{RS}
...
def main():
    ...
    while True:
        ...
        if choice in ACTIONS:
            ...
            print(f"\n{BR}{O}  WiFi Multi-Tool v3.3 — By AKO{RS}")
