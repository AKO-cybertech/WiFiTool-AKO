...
{BR}{PRI}
  ...
  ╚███╔███╔╝██║██║     ██║
   ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝{RS}
{DIM}        v3.9  ·  By AKO  ·  Windows Edition{RS}"""
...
MENU_PAGES = [
    ...
    {"cat": "menu_controle",   "items": [("20","m20"),("21","m21")]},
    {"cat": "menu_export",     "items": [("22","m22")]},
]
...
def build_page(page_idx):
    ...
    lines = [
        ...
        f"{BR}{PRI}  {t('menu_title')}{RS} {DIM}· v3.9 · By AKO{RS}",
        f"{DIM}  {chr(9552)*62}{RS}",
        f"",
        f"  {nav_b}     {dots}     {nav_n}",
        f"",
...
def main():
    ...
    while True:
        ...
        if choice == "n":
            ...
            clear_banner()
            print(f"\n{BR}{PRI}  WiFi Multi-Tool v3.9 — By AKO{RS}")
