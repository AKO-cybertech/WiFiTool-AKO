...
{BR}{PRI}
  ...
  ╚███╔███╔╝██║██║     ██║
   ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝{RS}
{DIM}        v3.4  ·  By AKO  ·  Windows Edition{RS}"""
...
MENU = f"""
{DIM}  {'═'*62}{RS}
{BR}{PRI}  WIFI MULTI-TOOL{RS} {DIM}· v3.4 · By AKO{RS}
{DIM}  {'═'*62}{RS}
...
def arp_block():
    ...
    print()
    choice = input(f"  {ACC}Numero de l'appareil (0=annuler) : {RS}").strip()
...
def main():
    ...
    while True:
        ...
        if choice in ACTIONS:
            ...
            print(f"\n{BR}{PRI}  WiFi Multi-Tool v3.4 — By AKO{RS}")
